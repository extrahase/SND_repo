...
ITEMS_TO_DESYNTH = {
    ...
    uncapped = { },
    nuts = {
        { name = "Neo Kingdom Earrings of Fending", shop = 2, category = 0, index = 38, price = 55 },
        { name = "Neo Kingdom Earrings of Slaying", shop = 2, category = 0, index = 39, price = 55 },
        { name = "Neo Kingdom Earrings of Aiming", shop = 2, category = 0, index = 40, price = 55 },
        { name = "Neo Kingdom Choker of Fending", shop = 2, category = 0, index = 41, price = 55 },
        { name = "Neo Kingdom Choker of Slaying", shop = 2, category = 0, index = 42, price = 55 },
        { name = "Neo Kingdom Choker of Aiming", shop = 2, category = 0, index = 43, price = 55 },
        { name = "Neo Kingdom Bangles of Fending", shop = 2, category = 0, index = 44, price = 55 },
        { name = "Neo Kingdom Bangles of Slaying", shop = 2, category = 0, index = 45, price = 55 },
        { name = "Neo Kingdom Bangles of Aiming", shop = 2, category = 0, index = 46, price = 55 },
        { name = "Neo Kingdom Ring of Fending", shop = 2, category = 0, index = 47, price = 55 },
        { name = "Neo Kingdom Ring of Slaying", shop = 2, category = 0, index = 48, price = 55 },
        { name = "Neo Kingdom Ring of Aiming", shop = 2, category = 0, index = 49, price = 55 },
...
local function SpendUncapped()
    ...
    if Inventory.GetItemCount(46850) >= 57 then
